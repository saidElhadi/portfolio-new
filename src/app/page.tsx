        ...
        <div className={`min-h-screen transition-all duration-500 `}>
                    ...
                    <div className="space-y-16">
                        ...
                        >
                            <div className="border-l-4 border-red-500 pl-6">
                                <h1 className="text-4xl lg:text-6xl font-bold mb-2 tracking-tight">SAID ELHADI</h1>
                                <p className="text-lg text-gray-600 dark:text-gray-400 font-mono">Full-Stack Developer & AI Researcher</p>
                            </div>

                            <div className="space-y-4 text-black dark:text-gray-200 max-w-md">
                                <div className='text-black dark:text-gray-200'>{resumeData.bio}</div>
                                <div className="flex items-center gap-2 text-sm">
                                    <MapPin size={14} className="text-red-500" />
                                    <span className="text-black dark:text-gray-200">{resumeData.personal.location}</span>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                {resumeData.experience.slice(0, 3).map((item, i) => (
                                    <div key={i} className="border-b border-gray-200 dark:border-gray-800 pb-3">
                                        <div className="flex items-center justify-between mb-1">
                                            <div className="flex items-center gap-2">
                                                <Briefcase size={12} className="text-red-500" />
                                                <span className="font-bold text-sm">{item.position}</span>
                                            </div>
                                            <span className="text-xs font-mono text-gray-600 dark:text-gray-400">{item.period}</span>
                                        </div>
                                        <div className="text-xs text-gray-800 dark:text-gray-300 mb-1">{item.company}</div>
                            ...
                            <div className="space-y-3">
                                {resumeData.education.map((item, i) => (
                                    <div key={i} className="border-b border-gray-200 dark:border-gray-800 pb-3">
                                        ...
                                        <div className="text-xs text-gray-800 dark:text-gray-300 mb-1">{item.school}</div>
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className={`text-xs px-2 py-1 border rounded ${item.status === 'In Progress' ? 'border-red-500 text-red-500' : 'border-green-500 text-green-600 dark:text-green-400'}`}>
                                                {item.status}
                                            </span>
                                        </div>
                                        <div className="text-xs text-gray-600 dark:text-gray-400">{item.description}</div>
                            ...
                            <div className="space-y-2">
                                {resumeData.awards.map((award, i) => (
                                    <div key={i} className="flex items-center justify-between text-sm">
                                        ...
                                        <span className="text-xs font-mono text-gray-600 dark:text-gray-400">{award.period}</span>
                                    </div>
                                ))}
                            </div>
                        </motion.div>
                    ...
                    >
                        ...
                        <div>
                            <div className="border-l-4 border-red-500 pl-6 mb-8">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 text-sm font-mono">Published research papers</p>
                            </div>
                            ...
                            <div className="space-y-6">
                                {resumeData.publications.map((pub, i) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">{pub.authors}</p>
                                        <p className="text-sm font-mono text-red-500">{pub.conference} • {pub.year}</p>
                                    </motion.div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="border-l-4 border-red-500 pl-6 mb-8">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 text-sm font-mono">Technical achievements and implementations</p>
                            </div>
                                ...
                                {resumeData.projects.slice(0, 6).map((project, i) => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-4">
                                            <h3 className="font-bold text-lg group-hover:text-red-500 transition-colors">{project.title}</h3>
                                            {project.link !== "#" && (
                                                <a
                                                    href={project.link}
                                                    target="_blank"
                                        ...
                                        <p className="text-sm font-mono text-red-500 mb-4">{project.status}</p>
            ...
            <div className="border-t border-gray-200 dark:border-gray-800 py-6">
                <div className="max-w-6xl mx-auto px-6">
                    <p className="text-xs font-mono text-gray-500 text-center">© 2025 SAID ELHADI</p>
                </div>
            </div>
        </div>
    );
